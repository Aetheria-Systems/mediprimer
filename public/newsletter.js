(function () {
  ...
  var MSG = {
    ...
    "vi": { ok: "Đã đăng ký. Chào mừng bạn!", err: "Không thành công — vui lòng kiểm tra địa chỉ email và thử lại." },
    "ko": { ok: "신청이 완료되었습니다. 환영합니다!", err: "신청되지 않았습니다 — 이메일 주소를 확인한 뒤 다시 시도해 주세요." },
    "tl": { ok: "Naipatala ka na. Maligayang pagdating!", err: "Hindi ito gumana — suriin ang address at subukan ulit." }
  };
