...
(function () {
  ...
  var STR = {
    ...
    "ko": {
      ...
      addRow: "항목 추가"},
    "tl": {
      s1: "1. Ang iyong plano ngayon",
      s1h: "Hanapin ang mga ito sa iyong plan card at sa pinakabagong bill mo.",
      planName: "Pangalan ng plano",
      planType: "Uri ng plano (Advantage, Part D, Medigap…)",
      premium: "Ang binabayaran mo bawat buwan ngayon",
      s2: "2. Ang sinasabi ng abiso na magbabago",
      s2h: "Ipinadala sa iyo ng plano mo ang Annual Notice of Change bago matapos ang Setyembre. Ihambing ang mga numero sa susunod na taon sa taong ito.",
      nextPremium: "Buwanang premium sa susunod na taon",
      nextDeductible: "Deductible sa susunod na taon",
      nextOOP: "Pinakamataas na out-of-pocket sa susunod na taon",
      biggest: "Ang pagbabagong pinakaikinababahala mo",
      s3: "3. Ang iyong mga gamot",
      s3h: "Ang pinakakaraniwang dahilan para lumipat ng plano ay ang pag-alis ng isang gamot sa listahan ng plano o paglipat nito sa mas mahal na tier.",
      drug: "Gamot",
      covered: "Saklaw pa rin sa susunod na taon?",
      cost: "Magkakano ito",
      s4: "4. Ang iyong mga doktor at parmasya",
      s4h: "Nagbabago ang network bawat taon. Suriin ang bawat isa para sa susunod na taon, hindi para sa taong ito.",
      provider: "Doktor, ospital, o parmasya",
      inNetwork: "Nasa network pa rin sa susunod na taon?",
      s5: "5. Ihambing bago magpasya",
      s5h: "Ilagay ang kasalukuyang plano mo sa tabi ng anumang isinasaalang-alang mo. Ipinapakita ng Plan Finder ng Medicare kung magkano ang gagastusin sa bawat isa kasama ang iyong mga gamot.",
      option: "Pagpipilian",
      monthly: "Buwanang premium",
      drugsCovered: "Saklaw ang iyong mga gamot?",
      doctorsIn: "Nasa network ang iyong mga doktor?",
      yearlyEst: "Tinatayang gastos para sa taon",
      current: "Ang kasalukuyan kong plano",
      alt1: "Alternatibo 1",
      alt2: "Alternatibo 2",
      s6: "6. Ang iyong desisyon",
      s6h: "Kung wala kang gagawin, karamihan sa mga plano ay awtomatikong nare-renew na may mga pagbabago sa susunod na taon.",
      decision: "Ang napagpasyahan ko",
      deadline: "Deadline: Disyembre 7",
      doneBy: "Kikilos ako bago ang",
      print: "I-print ang workbook na ito",
      clear: "Burahin ang lahat ng sagot",
      saved: "Naka-save lang sa browser na ito — walang ipinapadala kahit saan.",
      addRow: "Magdagdag pa"}
  };
