...
build:
	cd $(PUB) && python3 ../build/normalize.py && python3 ../build/assemble.py && python3 ../build/render_diagrams.py &&	python3 ../build/hot_topics.py && python3 ../build/newsletter_block.py && python3 ../build/seo.py $(DATE)
